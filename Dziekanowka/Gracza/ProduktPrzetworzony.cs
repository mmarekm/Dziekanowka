namespace Dziekanowka.Gracza
{
    public class ProduktPrzetworzony(string nazwa, int ilosc = 0) : IDar
    {
        ...
        new("sernik"), new("babkaPiaskowa"), new("jabłkoCiasto"), new("brzoskwiniaCiasto"), new("nektarynkaCiasto"), new("morelaCiasto"), new("śliwkaCiasto"), new("wiśniaCiasto"), new("gruszkaCiasto"),
